...
// import fs from "fs";
// import { downloadFileFromUrlAndSaveAtPathGiven } from "./Utilities.js";
...
//   const path = repoName + "/App.js";
//   const url = commonUrl + "App2.js";
//   downloadFileFromUrlAndSaveAtPathGiven({ path, url });
// };
...
//   nanoversion = null,
// }: InstallPackagesParams): Promise<void> => {
//   const syncCommand = isSyncFunctionalityRequired ? "rn-nano-sync " : "";
//   const nanoVer =
//     nanoversion != null && nanoversion != "" ? `@${nanoversion}` : "";
//   const installScreensAndSafeArea = `CD ${repoName} && npm install --save react-native-nano${nanoVer} react-native-rsa-native react-native-reanimated@3.6.2 react-native-safe-area-context react-native-screens realm@11.10.2 @notifee/react-native react-native-pager-view react-native-device-info react-native-image-crop-picker react-native-permissions@3.6.1 ${syncCommand} run `;
...
//   // if (!downloadresult) process.exit(-1);
//   const path = repoName + "/App.js";
//   downloadFileFromUrlAndSaveAtPathGiven({ path, url: commonUrl + "App3.js" });
// };
// interface downloadFileArg {
//   repoName: string;
//   commonUrl: string;
// }
// export const createBabelConfigFileForWindows = ({
//   repoName,
//   commonUrl,
// }: downloadFileArg) => {
...
//   // if (!downloadresult) process.exit(-1);
//   const path = repoName + "/babel.config.js";
//   downloadFileFromUrlAndSaveAtPathGiven({ path, url });
// };
// interface ProjectSetupParams {
//   repoName: string;
//   appId?: string | null;
//   appSecret?: string | null;
//   nanoversion: string;
