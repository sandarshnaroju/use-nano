...
export const createSyncEnabledProjectViaShellCommand = ({ projectName, nanoversion, reactNativeVers, userArgs, }) => {
    ...
    if (userArgs != null &&
        ...
        downloadFileWithCallback(babelDownloadUrl, projectName + "/babel.config.js", () => {
            addNanoConfigToExistingProject(projectName, userArgs["app-id"], userArgs["app-secret"], userArgs["app-url"]);
            return null;
        });
    }
};
